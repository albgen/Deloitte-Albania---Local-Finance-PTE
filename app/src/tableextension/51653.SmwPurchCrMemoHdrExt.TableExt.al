...
// ?|KS01   |KS01            |01.02.21|#KS01   |XHT |Added code on field "Dont Show in VAT Book","Vendor Cr. Memo No."
tableextension 51653 "Smw Purch. Cr. Memo Hdr. Ext" extends "Purch. Cr. Memo Hdr."
{
    fields
    {
        ...
        modify("Vendor Cr. Memo No.")
        {
            ...
            begin
                // #KS001.s
                IF Rec."Vendor Cr. Memo No." <> xRec."Vendor Cr. Memo No." THEN BEGIN
                    Type := Type::Purchase;
                    DocumentType := DocumentType::"Credit Memo";
                    VatEntry.SmwSetExternalDocNoInVatBook(Type, DocumentType, Rec."No.", Rec."Vendor Cr. Memo No.");
                END;
                // #KS001.e
            end;
        }
